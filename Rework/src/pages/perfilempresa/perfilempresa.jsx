        ...
        <>
         ...
         <div className="flex justify-center mt-20">
          ...
          <div className="flex mt-20 flex-col gap-8">
            <div className="flex shadow-md shadow-gray-600 flex-row items-center gap-4  justify-center  w-[500px] p-3 ">
                ...
                <div>
                    <h2> <p className=" py-2 bg-[#DBDBDB] text-center rounded-lg	">2.000$</p></h2>
                    <p className="text-[10px]">Oferta Activa:</p>
                    <p className="text-[10px]">Quedan 2 horas </p>
                    <p className="text-[10px]">Hora: 2pm 3pm</p>
                


                </div>
            </div>
            <div className="flex shadow-md shadow-gray-800/50 flex-row items-center gap-4  justify-center  w-[500px] p-3 ">
                <img className="w-20 " src={senora} alt="" />
                <div className="flex flex-col justify-center">
                    <h2 className="text-[18px]">Diseñador grafico creativo</h2>
                    <h3 className="text-[14px]">nombre de la empresa</h3>
